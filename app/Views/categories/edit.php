                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="/categories/<?= $category['id'] ?>" method="POST">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name" class="form-control <?= ($validation->hasError('name')) ? 'is-invalid' : ''; ?>" name="name" value="<?= $category['name'] ?>">
