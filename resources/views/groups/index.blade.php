        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>
                        {{ $title }}
                        <a href="{{ route('groups.create') }}" class="btn btn-primary rounded-pill"><i
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $g->name }}</td>
                                <td>
                                    <a href="{{ route('groups.edit', ['group'=>$g->id]) }}" class="btn btn-warning"><i
                                            class="fas fa-edit"></i></a>
                                    <form action="{{ route('groups.destroy', ['group'=>$g->id]) }}" method="POST"
                                        class="d-inline">
                                        @method('DELETE')
                                        @csrf
