                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('stores.update', ['store'=>$store->id]) }}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="active"
                                                        ...
                                                        <option value="1" {{ $store->active ? 'selected' : '' }}>Active
                                                        </option>
                                                        <option value="0" {{ !$store->active ? 'selected' : ''
                                                            }}>Inactive</option>
                                                    </select>
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
