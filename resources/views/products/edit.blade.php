                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                <form class="form form-vertical" enctype="multipart/form-data" action="{{ route('products.update', ['product'=>$product->id]) }}" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="store"
                                                        ...
                                                        @foreach ($stores as $s)
                                                        <option value="{{ $s->id }}" {{ $s->id == $product->store->id ? 'selected' : ''}}>{{ $s->name }}</option>
                                                        @endforeach
                                                    </select>
                                                    <p style="color: red">
                                                        {{ $errors->first('store') }}
