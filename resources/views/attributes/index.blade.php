        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>{{ $title }}
                        <a href="{{ route('attributes.create') }}" class="btn btn-primary rounded-pill"><i
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('attributes.values.index', ['attribute'=>$a->id]) }}"
                                        class="btn btn-primary"><i class="fas fa-cog"></i></a>
                                    <a href="{{ route('attributes.edit', ['attribute'=>$a->id]) }}"
                                        class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    <form action="{{ route('attributes.destroy', ['attribute'=>$a->id]) }}"
