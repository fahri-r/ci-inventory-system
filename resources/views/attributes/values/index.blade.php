        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>{{ $title }}
                        <a href="{{ route('attributes.values.create', ['attribute' => $attributeId]) }}"
                            class="btn btn-primary rounded-pill"><i class="fas fa-plus"></i></a>
                    </h3>
                </div>
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $av->name }}</td>
                                <td>
                                    <a href="{{ route('attributes.values.edit', ['attribute'=>$attributeId, 'value'=>$av->id]) }}"
                                        class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    <form
                                        action="{{ route('attributes.values.destroy', ['attribute'=>$attributeId, 'value'=>$av->id]) }}"
