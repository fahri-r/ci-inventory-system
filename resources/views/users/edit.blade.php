                                ...
                                <form class="form form-vertical"
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstname"
                                                        ...
                                                        name="firstname" value="{{ $user->userMeta->firstname }}">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="lastname"
                                                        ...
                                                        name="lastname" value="{{ $user->userMeta->lastname }}">
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="phone"
                                                        ...
                                                        name="phone" value="{{ $user->userMeta->phone }}">
                                                    <div class="invalid-feedback">
                                                        <i class="bx bx-radio-circle"></i>
                                                        {{ $errors->first('phone') }}
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                            id="male"  value="1" {{ $user->userMeta->gender == 1 ? 'checked' : '' }}>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                            id="female" value="0" {{ $user->userMeta->gender == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-12">
                                                <div class="alert alert-warning">Leave the password field empty if you
                                                    don't want to change.</div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
